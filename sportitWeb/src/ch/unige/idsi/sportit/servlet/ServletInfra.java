	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				infrastructure.setlatitude(Double.parseDouble(splitted[9]));
				infrastructure.setlongitude(Double.parseDouble(splitted[10]));
		...
		this.getServletContext()
				.getRequestDispatcher("/WEB-INF/affichageInfra.jsp")
